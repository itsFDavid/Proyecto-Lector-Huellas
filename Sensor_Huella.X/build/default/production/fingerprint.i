...
void Fingerprint_Init(unsigned long baud)
{
    ...
    BAUDCON = 0x00;
    BAUDCONbits.BRG16 = 1;
    vx = (unsigned int)(48000000/(baud*4))-1;
    SPBRG = vx & 0x00FF;
    SPBRGH = vx >> 8;
    PIE1bits.RCIE = 1;
    PIR1bits.RCIF = 0;
...
void Fingerprint_Read_Parameters(void)
{
    ...
    cont_rx = 0;
    while(cont_rx != 27);
    _delay((unsigned long)((300)*(48000000/4000000.0)));
    finger_size_l = request_fingerprint[15];
    while(request_fingerprint[9] != 0x00);
}
...
void __attribute__((picinterrupt(("")))) INT_UART_RX()
{
    if(PIR1bits.RCIF == 1)
    {

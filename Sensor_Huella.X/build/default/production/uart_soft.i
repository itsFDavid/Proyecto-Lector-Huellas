...
void S_Uart_Init(void)
{
  ...
  TRISDbits.RD1 = 1;
  LATDbits.LD0 = 1;
  _delay((unsigned long)((((1000000/9600)))*(48000000/4000000.0)));
}
...
void S_Uart_Send_Char(char Data)
{
    ...
    {
        if(Data&mask) LATDbits.LD0 = 1;
        else LATDbits.LD0 = 0;
        _delay((unsigned long)(((((1000000/9600)) - (4*16/48)))*(48000000/4000000.0)));
    }
    LATDbits.LD0 = 1;
    _delay((unsigned long)((((1000000/9600)))*(48000000/4000000.0)));
}
...
char S_Uart_Read(void)
{
    ...
    _delay((unsigned long)(((((1000000/9600))/2))*(48000000/4000000.0)));
    for(mask=0x01; mask!=0; mask=(unsigned char)(mask<<1))
    {
        _delay((unsigned long)(((((1000000/9600)) - (4*18/48)))*(48000000/4000000.0)));
        if(PORTDbits.RD1)Data = Data|mask;
    }
    _delay((unsigned long)((((1000000/9600)))*(48000000/4000000.0)));
    return Data;
}
